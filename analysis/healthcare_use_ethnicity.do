...
cap log close
macro drop hr
log using ./logs/`dataset'_healthcare_use_ethnicity.log, replace t
cap file close tablecontent
**Creates output file for each year (`dataset')
file open tablecontent using ./output/`dataset'_healthcare_use_ethnicity.csv, write text replace
**Column headings
...
/*
cap file close tablecontent
file open tablecontent using ./output/2017_healthcare_use_ethnicity.csv, write text replace
...
import delimited ./output/`dataset'_healthcare_use_ethnicity.csv, clear
...
export delimited "./output/`dataset'_healthcare_use_ethnicity.csv", replace
/*
import delimited ./output/2017_healthcare_use_ethnicity.csv, clear
local columns " "n_2017" "april" "may" "june" "july" "august" "september" "october" "november" "december" "january" "february" "march" "april" "
foreach col in `columns' {
replace `col'=. if `col'<=5
}
export delimited "./output/2017_healthcare_use_ethnicity.csv", replace
*/