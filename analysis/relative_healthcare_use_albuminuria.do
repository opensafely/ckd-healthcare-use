...
cap log close
macro drop hr
log using ./logs/relative_healthcare_use_albuminuria.log, replace t
cap file close tablecontent
**Creates output file for each year (`dataset')
file open tablecontent using ./output/relative_healthcare_use_albuminuria.csv, write text replace
**Column headings
...
file write tablecontent %4.2f (``x'_hospital_days') _tab %4.2f (``x'_critical_care_days') _tab %4.2f (``x'_emergency_days') _tab %4.2f (``x'_op_appts') _tab %4.2f (``x'_neph_appts') _tab %4.2f (``x'_gp_interactions') _tab %4.2f (``x'_blood_pressure') _tab %4.2f (``x'_albuminuria') _tab %4.2f (``x'_creatinine') _n
}
