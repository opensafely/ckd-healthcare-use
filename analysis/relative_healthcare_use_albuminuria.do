...
file write tablecontent %10.2f (``x'_hospital_days') _tab %10.2f (``x'_critical_care_days') _tab %10.2f (``x'_emergency_days') _tab %10.2f (``x'_op_appts') _tab %10.2f (``x'_neph_appts') _tab %10.2f (``x'_gp_interactions') _tab %10.2f (``x'_blood_pressure') _tab %10.2f (``x'_albuminuria') _tab %10.2f (``x'_creatinine') _n
}
