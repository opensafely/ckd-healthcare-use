...
cap log close
macro drop hr
log using ./logs/`dataset'_healthcare_use_v2_dialysis.log, replace t
cap file close tablecontent
**Creates output file for each year (`dataset')
file open tablecontent using ./output/`dataset'_healthcare_use_v2_dialysis.csv, write text replace
**Column headings
...
import delimited ./output/`dataset'_healthcare_use_v2_dialysis.csv, clear
...
export delimited "./output/`dataset'_healthcare_use_v2_dialysis.csv", replace
/*
