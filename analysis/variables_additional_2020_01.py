...
def generate_variables_additional_2020_01(index_date_variable):
    variables_additional_2020_01 = dict(    
    ...
    final_creatinine=patients.mean_recorded_value(
        creatinine_codes,
    ...
    return variables_additional_2020_01
