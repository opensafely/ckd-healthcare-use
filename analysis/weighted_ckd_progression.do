...
cap log close
macro drop hr
log using ./logs/weighted_ckd_progression.log, replace t

cap file close tablecontent
file open tablecontent using ./output/weighted_ckd_progression.csv, write text replace
...
local multiplier = 100000/`baseline_ckd_`x''
total weight
local baseline_ckd_`x' = r(table)[1,1] * `multiplier'
local baseline_ckd_`x'_ll = r(table)[5,1] * `multiplier'
local baseline_ckd_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_progression==0
local none_ckd_`x' = r(table)[1,1] * `multiplier'
local none_ckd_`x'_ll = r(table)[5,1] * `multiplier'
local none_ckd_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_progression==1
local ckd3_ckd_`x' = r(table)[1,1] * `multiplier'
local ckd3_ckd_`x'_ll = r(table)[5,1] * `multiplier'
local ckd3_ckd_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_progression==2
local ckd4_ckd_`x' = r(table)[1,1] * `multiplier'
local ckd4_ckd_`x'_ll = r(table)[5,1] * `multiplier'
local ckd4_ckd_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_progression==3
local dialysis_ckd_`x' = r(table)[1,1] * `multiplier'
local dialysis_ckd_`x'_ll = r(table)[5,1] * `multiplier'
local dialysis_ckd_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_progression==4
local kt_ckd_`x' = r(table)[1,1] * `multiplier'
local kt_ckd_`x'_ll = r(table)[5,1] * `multiplier'
local kt_ckd_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_progression==6
local deceased_ckd_`x' = r(table)[1,1] * `multiplier'
local deceased_ckd_`x'_ll = r(table)[5,1] * `multiplier'
local deceased_ckd_`x'_ul = r(table)[6,1] * `multiplier'

total weight if cardiovascular==1
local cardio_ckd_`x' = r(table)[1,1] * `multiplier'
local cardio_ckd_`x'_ll = r(table)[5,1] * `multiplier'
local cardio_ckd_`x'_ul = r(table)[6,1] * `multiplier'

**No CKD
total weight if ckd_group==0
local baseline_nockd_`x' = r(table)[1,1]
local multiplier = 100000/`baseline_nockd_`x''
total weight if ckd_group==0
local baseline_nockd_`x' = r(table)[1,1] * `multiplier'
local baseline_nockd_`x'_ll = r(table)[5,1] * `multiplier'
local baseline_nockd_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==0 & ckd_progression==0
local none_nockd_`x' = r(table)[1,1] * `multiplier'
local none_nockd_`x'_ll = r(table)[5,1] * `multiplier'
local none_nockd_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==0 & ckd_progression==1
local ckd3_nockd_`x' = r(table)[1,1] * `multiplier'
local ckd3_nockd_`x'_ll = r(table)[5,1] * `multiplier'
local ckd3_nockd_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==0 & ckd_progression==2
local ckd4_nockd_`x' = r(table)[1,1] * `multiplier'
local ckd4_nockd_`x'_ll = r(table)[5,1] * `multiplier'
local ckd4_nockd_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==0 & ckd_progression==3
local dialysis_nockd_`x' = r(table)[1,1] * `multiplier'
local dialysis_nockd_`x'_ll = r(table)[5,1] * `multiplier'
local dialysis_nockd_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==0 & ckd_progression==4
local kt_nockd_`x' = r(table)[1,1] * `multiplier'
local kt_nockd_`x'_ll = r(table)[5,1] * `multiplier'
local kt_nockd_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==0 & ckd_progression==6
local deceased_nockd_`x' = r(table)[1,1] * `multiplier'
local deceased_nockd_`x'_ll = r(table)[5,1] * `multiplier'
local deceased_nockd_`x'_ul = r(table)[6,1] * `multiplier'

total weight if cardiovascular==1 & ckd_group==0
local cardio_nockd_`x' = r(table)[1,1] * `multiplier'
local cardio_nockd_`x'_ll = r(table)[5,1] * `multiplier'
local cardio_nockd_`x'_ul = r(table)[6,1] * `multiplier'

**CKD stage 3
total weight if ckd_group==2
local baseline_ckd3_`x' = r(table)[1,1]
local multiplier = 100000/`baseline_ckd3_`x''
total weight if ckd_group==2
local baseline_ckd3_`x' = r(table)[1,1] * `multiplier'
local baseline_ckd3_`x'_ll = r(table)[5,1] * `multiplier'
local baseline_ckd3_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==2 & ckd_progression==0
local none_ckd3_`x' = r(table)[1,1] * `multiplier'
local none_ckd3_`x'_ll = r(table)[5,1] * `multiplier'
local none_ckd3_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==2 & ckd_progression==2
local ckd4_ckd3_`x' = r(table)[1,1] * `multiplier'
local ckd4_ckd3_`x'_ll = r(table)[5,1] * `multiplier'
local ckd4_ckd3_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==2 & ckd_progression==3
local dialysis_ckd3_`x' = r(table)[1,1] * `multiplier'
local dialysis_ckd3_`x'_ll = r(table)[5,1] * `multiplier'
local dialysis_ckd3_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==2 & ckd_progression==4
local kt_ckd3_`x' = r(table)[1,1] * `multiplier'
local kt_ckd3_`x'_ll = r(table)[5,1] * `multiplier'
local kt_ckd3_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==2 & ckd_progression==6
local deceased_ckd3_`x' = r(table)[1,1] * `multiplier'
local deceased_ckd3_`x'_ll = r(table)[5,1] * `multiplier'
local deceased_ckd3_`x'_ul = r(table)[6,1] * `multiplier' 

total weight if cardiovascular==1 & ckd_group==2
local cardio_ckd3_`x' = r(table)[1,1] * `multiplier'
local cardio_ckd3_`x'_ll = r(table)[5,1] * `multiplier'
local cardio_ckd3_`x'_ul = r(table)[6,1] * `multiplier'

**CKD stage 4/5
total weight if ckd_group==3
local baseline_ckd4_`x' = r(table)[1,1]
local multiplier = 100000/`baseline_ckd4_`x''
total weight if ckd_group==3
local baseline_ckd4_`x' = r(table)[1,1] * `multiplier'
local baseline_ckd4_`x'_ll = r(table)[5,1] * `multiplier'
local baseline_ckd4_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==3 & ckd_progression==0
local none_ckd4_`x' = r(table)[1,1] * `multiplier'
local none_ckd4_`x'_ll = r(table)[5,1] * `multiplier'
local none_ckd4_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==3 & ckd_progression==3
local dialysis_ckd4_`x' = r(table)[1,1] * `multiplier'
local dialysis_ckd4_`x'_ll = r(table)[5,1] * `multiplier'
local dialysis_ckd4_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==3 & ckd_progression==4
local kt_ckd4_`x' = r(table)[1,1] * `multiplier'
local kt_ckd4_`x'_ll = r(table)[5,1] * `multiplier'
local kt_ckd4_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==3 & ckd_progression==6
local deceased_ckd4_`x' = r(table)[1,1] * `multiplier'
local deceased_ckd4_`x'_ll = r(table)[5,1] * `multiplier'
local deceased_ckd4_`x'_ul = r(table)[6,1] * `multiplier'

total weight if cardiovascular==1 & ckd_group==3
local cardio_ckd4_`x' = r(table)[1,1] * `multiplier'
local cardio_ckd4_`x'_ll = r(table)[5,1] * `multiplier'
local cardio_ckd4_`x'_ul = r(table)[6,1] * `multiplier'

**Dialysis
total weight if ckd_group==4
local baseline_dialysis_`x' = r(table)[1,1]
local multiplier = 100000/`baseline_dialysis_`x''
total weight if ckd_group==4
local baseline_dialysis_`x' = r(table)[1,1] * `multiplier'
local baseline_dialysis_`x'_ll = r(table)[5,1] * `multiplier'
local baseline_dialysis_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==4 & ckd_progression==0
local none_dialysis_`x' = r(table)[1,1] * `multiplier'
local none_dialysis_`x'_ll = r(table)[5,1] * `multiplier'
local none_dialysis_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==4 & ckd_progression==4
local kt_dialysis_`x' = r(table)[1,1] * `multiplier'
local kt_dialysis_`x'_ll = r(table)[5,1] * `multiplier'
local kt_dialysis_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==4 & ckd_progression==6
local deceased_dialysis_`x' = r(table)[1,1] * `multiplier'
local deceased_dialysis_`x'_ll = r(table)[5,1] * `multiplier'
local deceased_dialysis_`x'_ul = r(table)[6,1] * `multiplier'

total weight if cardiovascular==1 & ckd_group==4
local cardio_dialysis_`x' = r(table)[1,1] * `multiplier'
local cardio_dialysis_`x'_ll = r(table)[5,1] * `multiplier'
local cardio_dialysis_`x'_ul = r(table)[6,1] * `multiplier'

**Kidney transplant
total weight if ckd_group==5
local baseline_kt_`x' = r(table)[1,1]
local multiplier = 100000/`baseline_kt_`x''
total weight if ckd_group==5
local baseline_kt_`x' = r(table)[1,1] * `multiplier'
local baseline_kt_`x'_ll = r(table)[5,1] * `multiplier'
local baseline_kt_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==5 & ckd_progression==0
local none_kt_`x' = r(table)[1,1] * `multiplier'
local none_kt_`x'_ll = r(table)[5,1] * `multiplier'
local none_kt_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==5 & ckd_progression==3
local dialysis_kt_`x' = r(table)[1,1] * `multiplier'
local dialysis_kt_`x'_ll = r(table)[5,1] * `multiplier'
local dialysis_kt_`x'_ul = r(table)[6,1] * `multiplier'

total weight if ckd_group==5 & ckd_progression==6
local deceased_kt_`x' = r(table)[1,1] * `multiplier'
local deceased_kt_`x'_ll = r(table)[5,1] * `multiplier'
local deceased_kt_`x'_ul = r(table)[6,1] * `multiplier'

total weight if cardiovascular==1 & ckd_group==5
local cardio_kt_`x' = r(table)[1,1] * `multiplier'
local cardio_kt_`x'_ll = r(table)[5,1] * `multiplier'
local cardio_kt_`x'_ul = r(table)[6,1] * `multiplier'
}
...
total weight if ckd_group==3 & ckd_progression==4
local kt_ckd4_2018 = r(table)[1,1] * `multiplier'
local kt_ckd4_2018_ll = r(table)[5,1] * `multiplier'
local kt_ckd4_2018_ul = r(table)[6,1] * `multiplier'
