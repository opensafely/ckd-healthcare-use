...
def generate_variables_additional_v2(index_date_variable):
    variables_additional_v2 = dict(    
    ...
    dialysis_baseline_date=patients.with_these_clinical_events(
        dialysis_codes,
        between = ["1970-01-01", "index_date - 1 day"],
        returning="date",
    ...
    dialysis_outcome_date=patients.with_these_clinical_events(
        dialysis_codes,
        between = ["index_date", "index_date + 364 days"],
        returning="date",
        date_format="YYYY-MM-DD",
    ...
    return variables_additional_v2
