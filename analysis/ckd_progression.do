...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_none_ckd2_2017') _tab _tab _tab %4.1f (`percent_none_ckd2_2018') _tab _tab _tab %4.1f (`percent_none_ckd2_2019') _tab _tab _tab %4.1f (`percent_none_ckd2_2020') _tab _tab _tab %4.1f (`percent_none_ckd2_2021') _tab _tab _tab %4.1f (`percent_none_ckd2_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_ckd3_ckd2_2017') _tab _tab _tab %4.1f (`percent_ckd3_ckd2_2018') _tab _tab _tab %4.1f (`percent_ckd3_ckd2_2019') _tab _tab _tab %4.1f (`percent_ckd3_ckd2_2020') _tab _tab _tab %4.1f (`percent_ckd3_ckd2_2021') _tab _tab _tab %4.1f (`percent_ckd3_ckd2_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_ckd4_ckd2_2017') _tab _tab _tab %4.1f (`percent_ckd4_ckd2_2018') _tab _tab _tab %4.1f (`percent_ckd4_ckd2_2019') _tab _tab _tab %4.1f (`percent_ckd4_ckd2_2020') _tab _tab _tab %4.1f (`percent_ckd4_ckd2_2021') _tab _tab _tab %4.1f (`percent_ckd4_ckd2_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_dialysis_ckd2_2017') _tab _tab _tab %4.1f (`percent_dialysis_ckd2_2018') _tab _tab _tab %4.1f (`percent_dialysis_ckd2_2019') _tab _tab _tab %4.1f (`percent_dialysis_ckd2_2020') _tab _tab _tab %4.1f (`percent_dialysis_ckd2_2021') _tab _tab _tab %4.1f (`percent_dialysis_ckd2_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_kt_ckd2_2017') _tab _tab _tab %4.1f (`percent_kt_ckd2_2018') _tab _tab _tab %4.1f (`percent_kt_ckd2_2019') _tab _tab _tab %4.1f (`percent_kt_ckd2_2020') _tab _tab _tab %4.1f (`percent_kt_ckd2_2021') _tab _tab _tab %4.1f (`percent_kt_ckd2_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_unclear_ckd2_2017') _tab _tab _tab %4.1f (`percent_unclear_ckd2_2018') _tab _tab _tab %4.1f (`percent_unclear_ckd2_2019') _tab _tab _tab %4.1f (`percent_unclear_ckd2_2020') _tab _tab _tab %4.1f (`percent_unclear_ckd2_2021') _tab _tab _tab %4.1f (`percent_unclear_ckd2_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_deceased_ckd2_2017') _tab _tab _tab %4.1f (`percent_deceased_ckd2_2018') _tab _tab _tab %4.1f (`percent_deceased_ckd2_2019') _tab _tab _tab %4.1f (`percent_deceased_ckd2_2020') _tab _tab _tab %4.1f (`percent_deceased_ckd2_2021') _tab _tab _tab %4.1f (`percent_deceased_ckd2_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_none_ckd3_2017') _tab _tab _tab %4.1f (`percent_none_ckd3_2018') _tab _tab _tab %4.1f (`percent_none_ckd3_2019') _tab _tab _tab %4.1f (`percent_none_ckd3_2020') _tab _tab _tab %4.1f (`percent_none_ckd3_2021') _tab _tab _tab %4.1f (`percent_none_ckd3_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_ckd4_ckd3_2017') _tab _tab _tab %4.1f (`percent_ckd4_ckd3_2018') _tab _tab _tab %4.1f (`percent_ckd4_ckd3_2019') _tab _tab _tab %4.1f (`percent_ckd4_ckd3_2020') _tab _tab _tab %4.1f (`percent_ckd4_ckd3_2021') _tab _tab _tab %4.1f (`percent_ckd4_ckd3_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_dialysis_ckd3_2017') _tab _tab _tab %4.1f (`percent_dialysis_ckd3_2018') _tab _tab _tab %4.1f (`percent_dialysis_ckd3_2019') _tab _tab _tab %4.1f (`percent_dialysis_ckd3_2020') _tab _tab _tab %4.1f (`percent_dialysis_ckd3_2021') _tab _tab _tab %4.1f (`percent_dialysis_ckd3_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_kt_ckd3_2017') _tab _tab _tab %4.1f (`percent_kt_ckd3_2018') _tab _tab _tab %4.1f (`percent_kt_ckd3_2019') _tab _tab _tab %4.1f (`percent_kt_ckd3_2020') _tab _tab _tab %4.1f (`percent_kt_ckd3_2021') _tab _tab _tab %4.1f (`percent_kt_ckd3_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_unclear_ckd3_2017') _tab _tab _tab %4.1f (`percent_unclear_ckd3_2018') _tab _tab _tab %4.1f (`percent_unclear_ckd3_2019') _tab _tab _tab %4.1f (`percent_unclear_ckd3_2020') _tab _tab _tab %4.1f (`percent_unclear_ckd3_2021') _tab _tab _tab %4.1f (`percent_unclear_ckd3_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_deceased_ckd3_2017') _tab _tab _tab %4.1f (`percent_deceased_ckd3_2018') _tab _tab _tab %4.1f (`percent_deceased_ckd3_2019') _tab _tab _tab %4.1f (`percent_deceased_ckd3_2020') _tab _tab _tab %4.1f (`percent_deceased_ckd3_2021') _tab _tab _tab %4.1f (`percent_deceased_ckd3_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_none_ckd4_2017') _tab _tab _tab %4.1f (`percent_none_ckd4_2018') _tab _tab _tab %4.1f (`percent_none_ckd4_2019') _tab _tab _tab %4.1f (`percent_none_ckd4_2020') _tab _tab _tab %4.1f (`percent_none_ckd4_2021') _tab _tab _tab %4.1f (`percent_none_ckd4_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_dialysis_ckd4_2017') _tab _tab _tab %4.1f (`percent_dialysis_ckd4_2018') _tab _tab _tab %4.1f (`percent_dialysis_ckd4_2019') _tab _tab _tab %4.1f (`percent_dialysis_ckd4_2020') _tab _tab _tab %4.1f (`percent_dialysis_ckd4_2021') _tab _tab _tab %4.1f (`percent_dialysis_ckd4_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_kt_ckd4_2017') _tab _tab _tab %4.1f (`percent_kt_ckd4_2018') _tab _tab _tab %4.1f (`percent_kt_ckd4_2019') _tab _tab _tab %4.1f (`percent_kt_ckd4_2020') _tab _tab _tab %4.1f (`percent_kt_ckd4_2021') _tab _tab _tab %4.1f (`percent_kt_ckd4_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_unclear_ckd4_2017') _tab _tab _tab %4.1f (`percent_unclear_ckd4_2018') _tab _tab _tab %4.1f (`percent_unclear_ckd4_2019') _tab _tab _tab %4.1f (`percent_unclear_ckd4_2020') _tab _tab _tab %4.1f (`percent_unclear_ckd4_2021') _tab _tab _tab %4.1f (`percent_unclear_ckd4_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_deceased_ckd4_2017') _tab _tab _tab %4.1f (`percent_deceased_ckd4_2018') _tab _tab _tab %4.1f (`percent_deceased_ckd4_2019') _tab _tab _tab %4.1f (`percent_deceased_ckd4_2020') _tab _tab _tab %4.1f (`percent_deceased_ckd4_2021') _tab _tab _tab %4.1f (`percent_deceased_ckd4_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_none_dialysis_2017') _tab _tab _tab %4.1f (`percent_none_dialysis_2018') _tab _tab _tab %4.1f (`percent_none_dialysis_2019') _tab _tab _tab %4.1f (`percent_none_dialysis_2020') _tab _tab _tab %4.1f (`percent_none_dialysis_2021') _tab _tab _tab %4.1f (`percent_none_dialysis_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_kt_dialysis_2017') _tab _tab _tab %4.1f (`percent_kt_dialysis_2018') _tab _tab _tab %4.1f (`percent_kt_dialysis_2019') _tab _tab _tab %4.1f (`percent_kt_dialysis_2020') _tab _tab _tab %4.1f (`percent_kt_dialysis_2021') _tab _tab _tab %4.1f (`percent_kt_dialysis_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_deceased_dialysis_2017') _tab _tab _tab %4.1f (`percent_deceased_dialysis_2018') _tab _tab _tab %4.1f (`percent_deceased_dialysis_2019') _tab _tab _tab %4.1f (`percent_deceased_dialysis_2020') _tab _tab _tab %4.1f (`percent_deceased_dialysis_2021') _tab _tab _tab %4.1f (`percent_deceased_dialysis_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_none_kt_2017') _tab _tab _tab %4.1f (`percent_none_kt_2018') _tab _tab _tab %4.1f (`percent_none_kt_2019') _tab _tab _tab %4.1f (`percent_none_kt_2020') _tab _tab _tab %4.1f (`percent_none_kt_2021') _tab _tab _tab %4.1f (`percent_none_kt_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_dialysis_kt_2017') _tab _tab _tab %4.1f (`percent_dialysis_kt_2018') _tab _tab _tab %4.1f (`percent_dialysis_kt_2019') _tab _tab _tab %4.1f (`percent_dialysis_kt_2020') _tab _tab _tab %4.1f (`percent_dialysis_kt_2021') _tab _tab _tab %4.1f (`percent_dialysis_kt_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_deceased_kt_2017') _tab _tab _tab %4.1f (`percent_deceased_kt_2018') _tab _tab _tab %4.1f (`percent_deceased_kt_2019') _tab _tab _tab %4.1f (`percent_deceased_kt_2020') _tab _tab _tab %4.1f (`percent_deceased_kt_2021') _tab _tab _tab %4.1f (`percent_deceased_kt_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_none_unclear_2017') _tab _tab _tab %4.1f (`percent_none_unclear_2018') _tab _tab _tab %4.1f (`percent_none_unclear_2019') _tab _tab _tab %4.1f (`percent_none_unclear_2020') _tab _tab _tab %4.1f (`percent_none_unclear_2021') _tab _tab _tab %4.1f (`percent_none_unclear_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_dialysis_unclear_2017') _tab _tab _tab %4.1f (`percent_dialysis_unclear_2018') _tab _tab _tab %4.1f (`percent_dialysis_unclear_2019') _tab _tab _tab %4.1f (`percent_dialysis_unclear_2020') _tab _tab _tab %4.1f (`percent_dialysis_unclear_2021') _tab _tab _tab %4.1f (`percent_dialysis_unclear_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_kt_unclear_2017') _tab _tab _tab %4.1f (`percent_kt_unclear_2018') _tab _tab _tab %4.1f (`percent_kt_unclear_2019') _tab _tab _tab %4.1f (`percent_kt_unclear_2020') _tab _tab _tab %4.1f (`percent_kt_unclear_2021') _tab _tab _tab %4.1f (`percent_kt_unclear_2022') _n(2)
...
file write tablecontent _tab ("%") _tab _tab _tab %4.1f (`percent_deceased_unclear_2017') _tab _tab _tab %4.1f (`percent_deceased_unclear_2018') _tab _tab _tab %4.1f (`percent_deceased_unclear_2019') _tab _tab _tab %4.1f (`percent_deceased_unclear_2020') _tab _tab _tab %4.1f (`percent_deceased_unclear_2021') _tab _tab _tab %4.1f (`percent_deceased_unclear_2022') _n(2)
