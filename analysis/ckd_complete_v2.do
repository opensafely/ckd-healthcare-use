...
cap log close
log using ./logs/`dataset'_ckd_complete_v2, replace t
clear

*Merge `dataset'_ckd_v2 with `dataset'_ckd_complete_v2
capture noisily import delimited ./output/`dataset'_ckd_v2.csv, clear
tempfile `dataset'_ckd_v2
save ``dataset'_ckd'_v2, replace
capture noisily import delimited ./output/input_`dataset'_ckd_complete_v2.csv, clear
merge 1:1 patient_id using ``dataset'_ckd'_v2
keep if _merge==3
drop _merge
tempfile `dataset'_ckd_complete_v2
save ``dataset'_ckd_complete'_v2, replace

/*Generate dummy data
cd ckd-healthcare-use
capture noisily import delimited ./output/2017_ckd_v2.csv, clear
tempfile 2017_ckd_v2
save 2017_ckd_v2, replace
capture noisily import delimited ./output/input_2017_ckd_complete_v2.csv, clear
merge 1:1 patient_id using 2017_ckd_v2
keep if _merge==3
drop _merge
tempfile 2017_ckd_complete_v2
save 2017_ckd_complete_v2, replace
*/
...
save "./output/`dataset'_ckd_complete_v2.dta", replace
log close

/*
save "./output/2017_ckd_complete_v2.dta", replace
*/
