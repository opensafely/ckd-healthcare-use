...
drop if ckd_group!=4
total weight
local denom = r(table)[1,1]

foreach outcome of varlist hospital_days critical_care_days emergency_days op_appts neph_appts tx_appts gp_interactions fistula_formation pd_insertion icd1_days icd2_days icd3_days icd4_days icd5_days icd6_days icd7_days icd8_days icd9_days icd10_days icd11_days icd12_days icd13_days icd14_days icd15_days icd16_days icd17_days icd18_days icd19_days icd20_days icd21_days icd22_days {
qui su std_`outcome'
local `x'_`outcome' = (r(mean)/`denom')*100000
