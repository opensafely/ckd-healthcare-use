...
cap log close
macro drop hr
log using ./logs/ckd_progression_ethnicity.log, replace t

cap file close tablecontent
file open tablecontent using ./output/ckd_progression_ethnicity.csv, write text replace
...
**Overall
qui safecount
local baseline_ckd_`x'`ethnicity' = round(r(N),5)
...
local unclear_ckd_`x'`ethnicity' = round(r(N),5)
...
local baseline_ckd3_`x'`ethnicity' = round(r(N),5)
*Number of people in group who do not progress by the end of the year
qui safecount if ckd_group==2 & ckd_progression==0
local none_ckd3_`x'`ethnicity' = round(r(N),5)
*Number of people in group who progress to CKD stage 4/5 (without KRT) by the end of the year
qui safecount if ckd_group==2 & ckd_progression==2
local ckd4_ckd3_`x'`ethnicity' = round(r(N),5)
*Number of people in group who progress to dialysis by the end of the year
qui safecount if ckd_group==2 & ckd_progression==3
local dialysis_ckd3_`x'`ethnicity' = round(r(N),5)
...
local kt_ckd3_`x'`ethnicity' = round(r(N),5)
*Number of people in group who progress to KRT (unclear modality) by the end of the year
qui safecount if ckd_group==2 & ckd_progression==5
local unclear_ckd3_`x'`ethnicity' = round(r(N),5)
*Number of people in group who die by the end of the year
qui safecount if ckd_group==2 & ckd_progression==6
local deceased_ckd3_`x'`ethnicity' = round(r(N),5)

**CKD stage 4/5 without KRT
*Number of people in group (baseline_ckd4_`x'`ethnicity') at the beginning of each year ckd4_`x'`ethnicity'
qui safecount if ckd_group==3
local baseline_ckd4_`x'`ethnicity' = round(r(N),5)
*Number of people in group who do not progress by the end of the year
qui safecount if ckd_group==3 & ckd_progression==0
local none_ckd4_`x'`ethnicity' = round(r(N),5)
*Number of people in group who progress to dialysis by the end of the year
qui safecount if ckd_group==3 & ckd_progression==3
local dialysis_ckd4_`x'`ethnicity' = round(r(N),5)
*Number of people in group who progress to kidney transplant by the end of the year
qui safecount if ckd_group==3 & ckd_progression==4
local kt_ckd4_`x'`ethnicity' = round(r(N),5)
*Number of people in group who progress to KRT (unclear modality) by the end of the year
qui safecount if ckd_group==3 & ckd_progression==5
local unclear_ckd4_`x'`ethnicity' = round(r(N),5)
*Number of people in group who die by the end of the year
qui safecount if ckd_group==3 & ckd_progression==6
local deceased_ckd4_`x'`ethnicity' = round(r(N),5)

**Dialysis
*Number of people in group (baseline_dialysis_`x'`ethnicity') at the beginning of each year dialysis_`x'`ethnicity'
qui safecount if ckd_group==4
local baseline_dialysis_`x'`ethnicity' = round(r(N),5)
*Number of people in group remaining on dialysis by the end of the year
qui safecount if ckd_group==4 & ckd_progression==0
local none_dialysis_`x'`ethnicity' = round(r(N),5)
*Number of people in group with kidney transplant by the end of the year
qui safecount if ckd_group==4 & ckd_progression==4
local kt_dialysis_`x'`ethnicity' = round(r(N),5)
*Number of people in group who die by the end of the year
qui safecount if ckd_group==4 & ckd_progression==6
local deceased_dialysis_`x'`ethnicity' = round(r(N),5)

**Kidney transplant
*Number of people in group (baseline_kt_`x'`ethnicity') at the beginning of each year kt_`x'`ethnicity'
qui safecount if ckd_group==5
local baseline_kt_`x'`ethnicity' = round(r(N),5)
...
local none_kt_`x'`ethnicity' = round(r(N),5)
*Number of people in group on dialysis by the end of the year
qui safecount if ckd_group==5 & ckd_progression==3
local dialysis_kt_`x'`ethnicity' = round(r(N),5)
*Number of people in group who die by the end of the year
qui safecount if ckd_group==5 & ckd_progression==6
local deceased_kt_`x'`ethnicity' = round(r(N),5)

**KRT unclear modality
*Number of people in group (baseline_unclear_`x'`ethnicity') at the beginning of each year unclear_`x'`ethnicity'
qui safecount if ckd_group==6
local baseline_unclear_`x'`ethnicity' = round(r(N),5)
*Number of people in group remaining in group by the end of the year
qui safecount if ckd_group==6 & ckd_progression==0
local none_unclear_`x'`ethnicity' = round(r(N),5)
*Number of people in group on dialysis by the end of the year
qui safecount if ckd_group==6 & ckd_progression==3
local dialysis_unclear_`x'`ethnicity' = round(r(N),5)
*Number of people in group with kidney transplant by the end of the year
qui safecount if ckd_group==6 & ckd_progression==4
local kt_unclear_`x'`ethnicity' = round(r(N),5)
*Number of people in group who die by the end of the year
...
file write tablecontent _tab ("No progression") _tab _tab (`none_ckd3_2017`ethnicity'') _tab _tab (`none_ckd3_2018`ethnicity'') _tab _tab (`none_ckd3_2019`ethnicity'') _tab _tab (`none_ckd3_2020`ethnicity'') _tab _tab (`none_ckd3_2021`ethnicity'') _tab _tab (`none_ckd3_2022`ethnicity'') _n
file write tablecontent _tab ("CKD stage 4/5") _tab _tab (`ckd4_ckd3_2017`ethnicity'') _tab _tab (`ckd4_ckd3_2018`ethnicity'') _tab _tab (`ckd4_ckd3_2019`ethnicity'') _tab _tab (`ckd4_ckd3_2020`ethnicity'') _tab _tab (`ckd4_ckd3_2021`ethnicity'') _tab _tab (`ckd4_ckd3_2022`ethnicity'') _n
file write tablecontent _tab ("Dialysis") _tab _tab (`dialysis_ckd3_2017`ethnicity'') _tab _tab (`dialysis_ckd3_2018`ethnicity'') _tab _tab (`dialysis_ckd3_2019`ethnicity'') _tab _tab (`dialysis_ckd3_2020`ethnicity'') _tab _tab (`dialysis_ckd3_2021`ethnicity'') _tab _tab (`dialysis_ckd3_2022`ethnicity'') _n
file write tablecontent _tab ("Transplant") _tab _tab (`kt_ckd3_2017`ethnicity'') _tab _tab (`kt_ckd3_2018`ethnicity'') _tab _tab (`kt_ckd3_2019`ethnicity'') _tab _tab (`kt_ckd3_2020`ethnicity'') _tab _tab (`kt_ckd3_2021`ethnicity'') _tab _tab (`kt_ckd3_2022`ethnicity'') _n
file write tablecontent _tab ("KRT unclear") _tab _tab (`unclear_ckd3_2017`ethnicity'') _tab _tab (`unclear_ckd3_2018`ethnicity'') _tab _tab (`unclear_ckd3_2019`ethnicity'') _tab _tab (`unclear_ckd3_2020`ethnicity'') _tab _tab (`unclear_ckd3_2021`ethnicity'') _tab _tab (`unclear_ckd3_2022`ethnicity'') _n
file write tablecontent _tab ("Deceased") _tab _tab (`deceased_ckd3_2017`ethnicity'') _tab _tab (`deceased_ckd3_2018`ethnicity'') _tab _tab (`deceased_ckd3_2019`ethnicity'') _tab _tab (`deceased_ckd3_2020`ethnicity'') _tab _tab (`deceased_ckd3_2021`ethnicity'') _tab _tab (`deceased_ckd3_2022`ethnicity'') _n(2)

*CKD stage 4/5 without KRT
file write tablecontent ("CKD stage 4/5") _tab _tab (`baseline_ckd4_2017`ethnicity'') _tab _tab (`baseline_ckd4_2018`ethnicity'') _tab _tab (`baseline_ckd4_2019`ethnicity'') _tab _tab (`baseline_ckd4_2020`ethnicity'') _tab _tab (`baseline_ckd4_2021`ethnicity'') _tab _tab (`baseline_ckd4_2022`ethnicity'') _n(2)
file write tablecontent _tab ("No progression") _tab _tab (`none_ckd4_2017`ethnicity'') _tab _tab (`none_ckd4_2018`ethnicity'') _tab _tab (`none_ckd4_2019`ethnicity'') _tab _tab (`none_ckd4_2020`ethnicity'') _tab _tab (`none_ckd4_2021`ethnicity'') _tab _tab (`none_ckd4_2022`ethnicity'') _n
file write tablecontent _tab ("Dialysis") _tab _tab (`dialysis_ckd4_2017`ethnicity'') _tab _tab (`dialysis_ckd4_2018`ethnicity'') _tab _tab (`dialysis_ckd4_2019`ethnicity'') _tab _tab (`dialysis_ckd4_2020`ethnicity'') _tab _tab (`dialysis_ckd4_2021`ethnicity'') _tab _tab (`dialysis_ckd4_2022`ethnicity'') _n
file write tablecontent _tab ("Transplant") _tab _tab (`kt_ckd4_2017`ethnicity'') _tab _tab (`kt_ckd4_2018`ethnicity'') _tab _tab (`kt_ckd4_2019`ethnicity'') _tab _tab (`kt_ckd4_2020`ethnicity'') _tab _tab (`kt_ckd4_2021`ethnicity'') _tab _tab (`kt_ckd4_2022`ethnicity'') _n
file write tablecontent _tab ("KRT unclear") _tab _tab (`unclear_ckd4_2017`ethnicity'') _tab _tab (`unclear_ckd4_2018`ethnicity'') _tab _tab (`unclear_ckd4_2019`ethnicity'') _tab _tab (`unclear_ckd4_2020`ethnicity'') _tab _tab (`unclear_ckd4_2021`ethnicity'') _tab _tab (`unclear_ckd4_2022`ethnicity'') _n
file write tablecontent _tab ("Deceased") _tab _tab (`deceased_ckd4_2017`ethnicity'') _tab _tab (`deceased_ckd4_2018`ethnicity'') _tab _tab (`deceased_ckd4_2019`ethnicity'') _tab _tab (`deceased_ckd4_2020`ethnicity'') _tab _tab (`deceased_ckd4_2021`ethnicity'') _tab _tab (`deceased_ckd4_2022`ethnicity'') _n(2)

*Dialysis
file write tablecontent ("Dialysis") _tab _tab (`baseline_dialysis_2017`ethnicity'') _tab _tab (`baseline_dialysis_2018`ethnicity'') _tab _tab (`baseline_dialysis_2019`ethnicity'') _tab _tab (`baseline_dialysis_2020`ethnicity'') _tab _tab (`baseline_dialysis_2021`ethnicity'') _tab _tab (`baseline_dialysis_2022`ethnicity'') _n(2)
file write tablecontent _tab ("No progression") _tab _tab (`none_dialysis_2017`ethnicity'') _tab _tab (`none_dialysis_2018`ethnicity'') _tab _tab (`none_dialysis_2019`ethnicity'') _tab _tab (`none_dialysis_2020`ethnicity'') _tab _tab (`none_dialysis_2021`ethnicity'') _tab _tab (`none_dialysis_2022`ethnicity'') _n
file write tablecontent _tab ("Transplant") _tab _tab (`kt_dialysis_2017`ethnicity'') _tab _tab (`kt_dialysis_2018`ethnicity'') _tab _tab (`kt_dialysis_2019`ethnicity'') _tab _tab (`kt_dialysis_2020`ethnicity'') _tab _tab (`kt_dialysis_2021`ethnicity'') _tab _tab (`kt_dialysis_2022`ethnicity'') _n
file write tablecontent _tab ("Deceased") _tab _tab (`deceased_dialysis_2017`ethnicity'') _tab _tab (`deceased_dialysis_2018`ethnicity'') _tab _tab (`deceased_dialysis_2019`ethnicity'') _tab _tab (`deceased_dialysis_2020`ethnicity'') _tab _tab (`deceased_dialysis_2021`ethnicity'') _tab _tab (`deceased_dialysis_2022`ethnicity'') _n(2)

*Kidney Transplant
file write tablecontent ("Transplant") _tab _tab (`baseline_kt_2017`ethnicity'') _tab _tab (`baseline_kt_2018`ethnicity'') _tab _tab (`baseline_kt_2019`ethnicity'') _tab _tab (`baseline_kt_2020`ethnicity'') _tab _tab (`baseline_kt_2021`ethnicity'') _tab _tab (`baseline_kt_2022`ethnicity'') _n(2)
file write tablecontent _tab ("No progression") _tab _tab (`none_kt_2017`ethnicity'') _tab _tab (`none_kt_2018`ethnicity'') _tab _tab (`none_kt_2019`ethnicity'') _tab _tab (`none_kt_2020`ethnicity'') _tab _tab (`none_kt_2021`ethnicity'') _tab _tab (`none_kt_2022`ethnicity'') _n
file write tablecontent _tab ("Dialysis") _tab _tab (`dialysis_kt_2017`ethnicity'') _tab _tab (`dialysis_kt_2018`ethnicity'') _tab _tab (`dialysis_kt_2019`ethnicity'') _tab _tab (`dialysis_kt_2020`ethnicity'') _tab _tab (`dialysis_kt_2021`ethnicity'') _tab _tab (`dialysis_kt_2022`ethnicity'') _n
file write tablecontent _tab ("Deceased") _tab _tab (`deceased_kt_2017`ethnicity'') _tab _tab (`deceased_kt_2018`ethnicity'') _tab _tab (`deceased_kt_2019`ethnicity'') _tab _tab (`deceased_kt_2020`ethnicity'') _tab _tab (`deceased_kt_2021`ethnicity'') _tab _tab (`deceased_kt_2022`ethnicity'') _n(2)

*KRT unclear modality
file write tablecontent ("KRT unclear") _tab _tab (`baseline_unclear_2017`ethnicity'') _tab _tab (`baseline_unclear_2018`ethnicity'') _tab _tab (`baseline_unclear_2019`ethnicity'') _tab _tab (`baseline_unclear_2020`ethnicity'') _tab _tab (`baseline_unclear_2021`ethnicity'') _tab _tab (`baseline_unclear_2022`ethnicity'') _n(2)
file write tablecontent _tab ("No progression") _tab _tab (`none_unclear_2017`ethnicity'') _tab _tab (`none_unclear_2018`ethnicity'') _tab _tab (`none_unclear_2019`ethnicity'') _tab _tab (`none_unclear_2020`ethnicity'') _tab _tab (`none_unclear_2021`ethnicity'') _tab _tab (`none_unclear_2022`ethnicity'') _n
file write tablecontent _tab ("Dialysis") _tab _tab (`dialysis_unclear_2017`ethnicity'') _tab _tab (`dialysis_unclear_2018`ethnicity'') _tab _tab (`dialysis_unclear_2019`ethnicity'') _tab _tab (`dialysis_unclear_2020`ethnicity'') _tab _tab (`dialysis_unclear_2021`ethnicity'') _tab _tab (`dialysis_unclear_2022`ethnicity'') _n
file write tablecontent _tab ("Transplant") _tab _tab (`kt_unclear_2017`ethnicity'') _tab _tab (`kt_unclear_2018`ethnicity'') _tab _tab (`kt_unclear_2019`ethnicity'') _tab _tab (`kt_unclear_2020`ethnicity'') _tab _tab (`kt_unclear_2021`ethnicity'') _tab _tab (`kt_unclear_2022`ethnicity'') _n
file write tablecontent _tab ("Deceased") _tab _tab (`deceased_unclear_2017`ethnicity'') _tab _tab (`deceased_unclear_2018`ethnicity'') _tab _tab (`deceased_unclear_2019`ethnicity'') _tab _tab (`deceased_unclear_2020`ethnicity'') _tab _tab (`deceased_unclear_2021`ethnicity'') _tab _tab (`deceased_unclear_2022`ethnicity'') _n(2)
}
