...
cap log close
log using ./logs/2019_ckd, replace t
clear

import delimited ./output/input_2019.csv, delimiter(comma) varnames(1) case(preserve) 
...
export delimited using "./output/2019_ckd.csv", replace
