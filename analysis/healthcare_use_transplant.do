...
cap log close
macro drop hr
log using ./logs/healthcare_use_transplant.log, replace t
...
import delimited ./output/healthcare_use_transplant.csv, clear
...
export delimited "./output/healthcare_use_transplant.csv", replace
