...
cap log close
macro drop hr
log using ./logs/standardised_healthcare_use_transplant.log, replace t
cap file close tablecontent
**Creates output file for each year (`dataset')
file open tablecontent using ./output/standardised_healthcare_use_transplant.csv, write text replace
**Column headings
