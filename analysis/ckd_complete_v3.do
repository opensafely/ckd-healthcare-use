...
keep if _merge==3
drop _merge
tempfile `dataset'_ckd_complete_v3
save ``dataset'_ckd_complete_v3', replace
...
save "./output/`dataset'_ckd_complete_v3.dta", replace
log close

/*
save "./output/2017_ckd_complete_v3.dta", replace
*/
