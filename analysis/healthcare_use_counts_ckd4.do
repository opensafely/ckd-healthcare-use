...
cap log close
macro drop hr
log using ./logs/healthcare_use_counts_ckd4.log, replace t
cap file close tablecontent
**Creates output file for each year (`dataset')
file open tablecontent using ./output/healthcare_use_counts_ckd4.csv, write text replace
**Column headings
...
import delimited ./output/healthcare_use_counts_ckd4.csv, clear
...
export delimited "./output/healthcare_use_counts_ckd4.csv", replace
