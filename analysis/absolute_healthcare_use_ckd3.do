...
cap log close
macro drop hr
log using ./logs/absolute_healthcare_use_ckd3.log, replace t
cap file close tablecontent
**Creates output file for each year (`dataset')
file open tablecontent using ./output/absolute_healthcare_use_ckd3.csv, write text replace
**Column headings
...
import delimited ./output/absolute_healthcare_use_ckd3.csv, clear
...
export delimited "./output/absolute_healthcare_use_ckd3.csv", replace
