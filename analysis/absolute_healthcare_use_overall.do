...
cap log close
macro drop hr
log using ./logs/absolute_healthcare_use_overall.log, replace t
...
import delimited ./output/absolute_healthcare_use_overall.csv, clear
...
export delimited "./output/absolute_healthcare_use_overall.csv", replace
